<div class="relative bg-white" x-data="{ mobileOpen: false }">
            ...
            <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
                <nav class="flex space-x-10">
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg bg-white">
                            <div
                                    ...
                                    <div class="flex md:h-full lg:flex-col">
                                        <div class="flex-shrink-0">
                                            <span class="inline-flex items-center justify-center h-10 w-10 rounded-md bg-indigo-500 text-white sm:h-12 sm:w-12">
                                                ...
                                                <x-icon icon="chart" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                                                        stroke="currentColor"
                                                        aria-hidden="true"></x-icon>
                                            </span>
                                        </div>
                                        <div
                    ...
                    <div x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"    class="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg">
                                        ...
                                        <ul class="mt-6 space-y-6">
                                                ...
                                                <a href="#" class="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
                                                    <div class="hidden sm:block flex-shrink-0">
                                                        <img class="w-32 h-20 object-cover rounded-md"
                                                             src="https://images.unsplash.com/photo-1558478551-1a378f63328e?ixlib=rb-1.2.1&ixqx=VTB1u3Ffq0&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2849&q=80"
                                                             alt="">
                                                    </div>
                                            ...
                                            <li class="flow-root">
                                                <a href="#" class="-m-3 p-3 flex rounded-lg hover:bg-gray-100">
                                                    <div class="hidden sm:block flex-shrink-0">
                                                        <img class="w-32 h-20 object-cover rounded-md"
                                                             src="https://images.unsplash.com/1/apple-gear-looking-pretty.jpg?ixlib=rb-1.2.1&ixqx=VTB1u3Ffq0&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80"
                                                             alt="">
                                                    </div>
                                                    <div class="w-0 flex-1 sm:ml-8">
                                                        <h4 class="text-base font-medium text-gray-900 truncate">
    ...
    <div class="absolute z-30 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50" x-show="mobileOpen" @click.away="mobileOpen = false">
